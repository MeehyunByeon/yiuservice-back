...
//        return new ResponseEntity<Boolean>(noticeService.create(user.getStudentId(), request), HttpStatus.OK);
//    }
//
//    // 공지사항 수정 [writer]
...
//        return new ResponseEntity<Boolean>(noticeService.update(user.getStudentId(), request), HttpStatus.OK);
//    }
//
//    // 공지사항 삭제 [writer]
...
//        return new ResponseEntity<Boolean>(noticeService.delete(user.getStudentId(), request), HttpStatus.OK);
//    }
}
